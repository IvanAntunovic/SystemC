...
void Capsule_Pinger::transitionaction_____Initial( const UMLRTMessage * msg )
{
    ...
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongV2/PingPongV2.uml PingPongV2::Pinger transition subvertex0,Playing */
...
void Capsule_Pinger::actionchain_____transition1( const UMLRTMessage * msg )
{
